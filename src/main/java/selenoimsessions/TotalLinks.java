...
public class TotalLinks {
	...
	public static void main(String[] args) {
		...
		//4.capture the text in alist and return
...
//		List<WebElement> linksList=driver.findElements(By.tagName("a"));   //whenever we need to intract with mulpitle elements we use find elements
//		
